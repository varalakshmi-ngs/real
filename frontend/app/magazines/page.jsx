      ...
      <AnimatePresence>
        ...
        {selectedPdf && (
          ...
          >
            ...
            <div className="h-[90px] bg-[#1557ff] flex items-center justify-between px-6 sm:px-10 shadow-lg">
            ...
            <div className="w-full h-[calc(100vh-90px)] overflow-auto bg-[#dfe1e5] flex justify-center py-10">
