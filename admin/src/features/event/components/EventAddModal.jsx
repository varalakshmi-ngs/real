...
import { eventValidation } from "../../../validations/HomePageValidations";
import { useAddEventHook } from "../Hooks/addEvent.hook";
import CustomInput from "../../../utils/CustomInput";
import { APIURL } from "../../../Core/url";
import { motion } from "framer-motion";

const EventAddModal = ({ fetchEvent, handleCloseModal, initialData }) => {
  const {
    register,
    handleSubmit,
    reset,
    ...
    resolver: zodResolver(eventValidation(!!initialData)),
  ...
  const { handleEventSubmit, loading, error, success } = useAddEventHook({
    fetchEvent,
    handleCloseModal,
    initialData,
    reset,
    ...
    >
      ...
      >
        ...
        <p className="text-slate-400">
          {initialData ? "Update your event details" : "Fill in the details to create a new event"}
        </p>
      </motion.div>
      ...
      <motion.div
        ...
        className="space-y-6"
      >
        <h3 className="text-lg font-semibold text-white border-b border-slate-600 pb-2">Event Details</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <CustomInput
            label="Event Type"
            placeholder="e.g., Worship Service, Conference, Workshop"
            name="eventType"
            register={register}
      ...
      <motion.div
        ...
        className="space-y-6"
      >
        <h3 className="text-lg font-semibold text-white border-b border-slate-600 pb-2">Event Image</h3>
