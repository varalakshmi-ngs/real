...
import ContributionEditor from "../dashboard/components/ContributionPageComponents/ContributionEditor";
...
const Contribution = () => {
  ...
  const tabs = [
    { id: "records", label: "Donation Records" },
    { id: "content", label: "Edit Page Content" },
  ];
