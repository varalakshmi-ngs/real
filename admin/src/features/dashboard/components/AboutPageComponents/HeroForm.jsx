...
import { heroSectionValidation } from "../../../../validations/AboutValidations";
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-800">About Page Content</h3>
            </div>
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-xl p-6 border border-slate-200">
              ...
              <p className="text-sm text-slate-500 mt-4 text-center">
                Upload a high-quality image for the about page hero
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          ...
          >
            ...
            {isSubmitting ? 'Updating...' : 'Update About Hero'}
          </motion.button>
        </motion.div>
      </motion.form>
    </OpenCloseLayout>
